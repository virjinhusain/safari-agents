      ...
      <table className="w-full text-lg text-left text-gray-500 dark:text-gray-400">
        <thead className="text-lg text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr className="bg-gray-100 dark:bg-gray-800">
            <th className="px-3 py-3 text-left text-lg font-medium text-gray-500 uppercase dark:text-gray-400">
              No
            </th>
            <th className="px-3 py-3 text-left text-lg font-medium text-gray-500 uppercase dark:text-gray-400">
              Travel Agent
            </th>
            <th className="px-1 py-3 text-left text-lg font-medium text-gray-500 uppercase dark:text-gray-400">
              Gross Sales 2022
            </th>
            <th className="px-1 py-3 text-left text-lg font-medium text-gray-500 uppercase dark:text-gray-400">
              Gross Sale 2023
